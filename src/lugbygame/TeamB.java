...
public class TeamB implements Strategy {
	...
	public void execute(Status currentStatus, Order resultOrder) {
		...
		System.out.println("B::" + currentStatus.turn);
		resultOrder.dx[2]++;
		...
		// resultOrder.dx[i] = 1;
		// else if (currentStatus.ball.x < currentStatus.mine[i].x + (getRandom(0, 2) -
		// 1))
		// resultOrder.dx[i] = -1;
		// else
		// resultOrder.dx[i] = 0;
		...
		// resultOrder.dy[i] = 1;
		// else if (currentStatus.ball.y < currentStatus.mine[i].y + (getRandom(0, 2) -
		// 1))
		// resultOrder.dy[i] = -1;
		// else
		// resultOrder.dy[i] = 0;
